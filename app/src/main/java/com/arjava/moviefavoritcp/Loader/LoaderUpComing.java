...
public class LoaderUpComing extends AsyncTaskLoader<ArrayList<MovieModel>> {

    private ArrayList<MovieModel> sDataMovie;
    private boolean hasResult = false;
    private String TAG = LoaderUpComing.class.getSimpleName();

    public LoaderUpComing(Context context) {
        super(context);
        onContentChanged();
    }
    ...
    public ArrayList<MovieModel> loadInBackground() {
        ...
        String urlTopRated = "movie/upcoming?api_key=";
